...
<Note> PRO TIP: fetching ERC721/1155 token IDs <br/>
In order to fetch ERC721/1155 token balances, you must pass the "contractAddress" to <br/>
the `GetTokenBalances` method. See section below for more information.</Note>
