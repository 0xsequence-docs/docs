...
<Note>Sequence Indexer endpoints<br/>
Sequence Indexer offers the same API across a variety of EVM networks. Make sure to check the Indexer endpoints<br/>
and use the corresponding host for your dapp/game. For example, on Ethereum mainnet the Sequence Indexer endpoint is<br/>
https://mainnet-indexer.sequence.app and Polygon is https://polygon-indexer.sequence.app.<br/>
🌄 [View the full list of supported networks and Indexer endpoints here](/indexer#supported-networks--endpoints)</Note>
