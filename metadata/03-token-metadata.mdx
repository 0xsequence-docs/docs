...
<Tip> PRO TIP: Sequence Indexer also supports token metadata <br/>
When using the [Sequence Indexer](/indexer), pass `"includeMetadata": true` to your request to <br/>
query token metadata for any ERC721 or ERC1155 contract. See below how to fetch <br/>
token metadata directly. </Tip>
