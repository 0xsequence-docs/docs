...
<img src="/assets/images/sequence_fee_options.png" />

## How to sponsor transaction fees for your users

It is possible for your dapp or game to sponsor the transaction fees of their users in a non-custodial way. Please [get in touch](/support) to enable it for your project.

<img src="/assets/images/sequence_free_fee.png" />

## Relaying Transaction

Since Sequence wallets are smart contracts, they can't execute transactions on their own. As a result, users transactions must be *relayed* by a third party. Technically, anyone can relay these transactions, but the current wallet interface does not allow users to change which relayer they want to use. In the future, we plan on offering more freedom on that front.
