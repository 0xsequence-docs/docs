---
title: Building a Relaying Server with Sequence
---
...
<Info> Sequentual Transactions <br />
By default, Sequence transactions will be executed sequentially. </Info>
...
<Tip> Need access to our Sequence Builder? <br />
Reach out to us by email @ hello@sequence.io or complete our Sequence Pro form to hear back: https://pro.sequence.xyz/. </Tip>
...
<Info> Already Deployed Contract <br />
For this example, we assume you have a smart contract deployed with a contract address to include in the last step. </Info>

### A. Create Dapp

![Sequence builder create app](/assets/images/builder/builder_create_dapp.png)

### B. New Dapp

![Sequence builder new dapp](/assets/images/builder/builder_new_dapp.png)

### C.1 Gas Tank

![Sequence builder gas tank](/assets/images/builder/builder_gas_tank.png)

### C.2 Add Gas

![Sequence builder add gas](/assets/images/builder/builder_add_gas.png)

### C.3 Add Sponsored Address

![Sequence builder add sponsored address](/assets/images/builder/builder_add_sponsored_address.png)
