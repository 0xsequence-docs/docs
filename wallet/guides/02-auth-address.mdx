...
description: Authenticate Users with Message Signature
---
...
![Sequence on-demand sign in, connect](/assets/images/build/authorize-connect.png)
...
a simple convention from [ethauth](https://github.com/0xsequence/ethauth.js). NOTE: EIP712 allows you to use an actual object for 
