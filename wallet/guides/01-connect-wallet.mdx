...
<Note> A delightful wallet without requiring your users to install anything :D <br />
By integrating `0xsequence`, users may access your dapp without having to install any special extensions,
and the wallet also works on mobile browsers! </Note>
...
const wallet = await sequence.initWallet();
...
<Tip> Check out some example Dapp source code <br/>
For a complete examples, see [Demo-Dapp](https://github.com/0xsequence/demo-dapp) and [Demo-Dapp-Web3Modal](https://github.com/0xsequence/demo-dapp-web3modal).</Tip>

<Warning> Avoid Browsers Blocking Sequence Popup <br/>
Most browsers will block popups if they are called outside of user-triggered event handlers like `onclick`, or when it takes too long to process between the user action and the actual window <br/>
Read more about browser popup-blocking [here](https://javascript.info/popup-windows#popup-blocking). </Warning>

![Sequence on-demand sign in](/assets/images/build/sign-in-fresh.png)

![Sequence on-demand sign in, connect](/assets/images/build/sign-in-connect.png)
...
![Sequence Web3Modal Integration](/assets/images/web3modal.png)
...
![Sequence Chrome Extension](/assets/images/build/seq-chrome-store.png)
...
<img src="/assets/images/walletconnect/connect-wallet.png" />

The user selects the WalletConnect option.

<img src="/assets/images/walletconnect/select-walletconnect.png" />
...
<img src="/assets/images/walletconnect/qr-code.png" />

Back in the Sequence interface, the user chooses "Scan".

<img src="/assets/images/walletconnect/scan.png" />
...
<img src="/assets/images/walletconnect/scan-qr-code.png" />

The user confirms the connection request.

<img src="/assets/images/walletconnect/confirm.png" />

The connection succeeded, and the dapp is updated to reflect that.

<img src="/assets/images/walletconnect/success.png" />
...
<img src="/assets/images/walletconnect/activity.png" />

Once the user has finished using the dapp, they can disconnect the wallet via the session menu.

<img src="/assets/images/walletconnect/disconnect.png" />
