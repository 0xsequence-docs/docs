...
<Tip> Try it live :)<br/>
Try [a live Dapp example](https://0xsequence.github.io/demo-dapp-rainbowkit/) using Sequence + Metamask + Rainbow + Wallet Connect with RainbowKit.<br/>
Source code is available too: [https://github.com/0xsequence/demo-dapp-rainbowkit](https://github.com/0xsequence/demo-dapp-rainbowkit)</Tip>
...
See [this section](https://docs.sequence.xyz/wallet/connectors/FAQ/#how-do-i-use-a-wallet-library-and-connector-with-nextjs-using-the-app-directory-version-13-and-above-only) for an explanation on using Wagmi or Wagmi-based libraries with `app` router.  
...
See [this section](https://docs.sequence.xyz/wallet/connectors/FAQ/#how-do-i-use-a-wallet-library-and-connector-with-nextjs-using-the-pages-directory-all-versions-of-nextjs) for an explanation on using Wagmi or Wagmi-based libraries with `pages` router.  
