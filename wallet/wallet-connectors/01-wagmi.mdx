...
<Tip> Try it live<br/>
Try [a live Dapp example](https://0xsequence.github.io/demo-dapp-wagmi/) using Sequence + Metamask + Wallet Connect with wagmi.<br/>
Source code is available too: [https://github.com/0xsequence/demo-dapp-wagmi](https://github.com/0xsequence/demo-dapp-wagmi)</Tip>
